...
public class CreateDatabaseTables extends BasicTableOperation {
    ...
    /**
     * This method creates all the tables mentioned in schema
     *
     */
    ...
    /**
     * This method drops all the tables mentioned in the drop file
     */
    ...
    /**
     * The method that does all the actual work. It loads the contents of the
     * sql file in a list an then executes it line by line at the end all the
     * actions are commited.
     */
