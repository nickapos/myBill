...
import gr.oncrete.nick.myBill.BusinessLogic.ImportDB.*;
...
public class billsUI extends javax.swing.JFrame {
    ...
    /**
     * this method will calculate the income received in a month sutract it from the amount spent at the same month
    ...
    /**
     * this method is used to create a new set of internationalized column names for the report table.
     */
    ...
    /**
     * this private method will check and preform the appropriate action
     * when go button in bills tab is clicked or when the user press enter
     * at the price value of the bill tab
     */
    ...
    /**
     * this method will be called when the user hits the go button in the income tab
     * or if he hits enter in the amount field
     */
    ...
    /**
     * this method is used by the insert action button or if the user
     * hits enter at the company name textfield
     */
